...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~Team #bearboy01 bot~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #bearboy01 bot " ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
client.on('message', message => {
    ...
    if (message.content === "Plus Bot") {
        ...
        message.edit('**Bear Boy**')
        message.edit('**Bear Boy **')
        message.edit('**Bear Boy 0**')
        message.edit('**Bear Boy 01**')
        message.edit('**Bear Boy 01 B**')
        message.edit('**Bear Boy 01 Bo**')
        message.edit('**Bear Boy 01 Bot ..**')
        }, 1000)
    }
...
if (message.content === (prefix + "support")) {
     message.author.send('https://discord.gg/RR7UKPS').catch(e => console.log(e.stack));
    }
   } 
  });
...
if (message.author.id !== '536928110055260170') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult, "https://www.twitch.tv/yumepaul");
